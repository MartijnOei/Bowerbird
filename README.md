...
The [Named Link](https://en.wikipedia.org/wiki/Silhouette_(clustering) "silhouette") is a standard clustering performance measure, and the distribution of silhouettes per cluster are part of Bowerbird's standard output:
